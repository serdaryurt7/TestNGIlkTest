...
public abstract class TestBaseRapor {
    ...
    protected static ExtentTest extentTest; // test pass veya failed gibi bilgileri kaydeder. Ayrıca
    ...
    public void setUpTest() {
        ...
        // oluşturmak istediğimiz raporu (html formatında) başlatıyoruz, filePath ile dosya yolunu be
        ...
        extentReports.setSystemInfo("Test Automation Engineer", "Serdar");
    ...
    public void teearDownMethod(ITestResult result) throws IOException {
